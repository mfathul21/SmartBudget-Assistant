...
class InterpretationMiddleware:
    ...
    def build_confirmation_response(
        self, checkpoint: InterpretationCheckpoint
    ) -> Dict[str, Any]:
        """
    ...
    def handle_confirmation_response(
        self, checkpoint: InterpretationCheckpoint, user_response: str
    ) -> Dict[str, Any]:
        """
    ...
    def save_interpretation_checkpoint(
        self, user_id: int, conversation_id: int, checkpoint: InterpretationCheckpoint
    ) -> bool:
        """
